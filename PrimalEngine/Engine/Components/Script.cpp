...
namespace primal::script
{
    ...
    namespace detail
    {
        ...
        {
            Boolean result { registry().insert(script_registry::value_type { tag, func }).second };
            assert(result);
            return result;
        }
    }
    ...
    component create(init_info info, game_entity::entity entity)
    {
        ...
        assert(entity_scripts.emplace_back()->get_id() == entity.get_id());
