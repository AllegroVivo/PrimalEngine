...
public partial class NewScriptDialog : Window
{
    ...
    Boolean Validate()
    {
        ...
        if (String.IsNullOrEmpty(name))
            ...
            errorMsg = "Select a valid script directory.";
        else if (path.IndexOfAny(Path.GetInvalidPathChars()) != -1)
            errorMsg = "Invalid characters used in directory path.";
            ...
            errorMsg = "Script must be added to (a sub-directory of) GameCode.";
